...
**Note:** You will need to repeat this every time SnowRunner receives a patch, or if you ever have Steam validate the files (including moving the game to a new location). If you forget to do this and load up your profile, any modifications you made to your trucks that weren't possible in Vanilla will get reset.

# How to Uninstall

Have Steam verify files. It will download a fresh copy of `initial.pak`.

**Note:** If you decided to make a backup of initial.pak you should move it out of the "client" folder, as the game will attempt to load _all_ .pak files in this location, including your backup.
...
I wanted a more nuanced solution here but while asphalt, dirt, and mud/snow all have friction modifiers you can tune and adjust, ice just as a simple on/off toggle. Either the tires ignore ice or they don't.
...
![Derry Longhorn 4520](img/Derry_Longhorn_4520.png)
...
![Pacific P12W](img/Pacific_P12W.png)
...
![Pacific P16](img/Pacific_P16.png)
...
Instead of adding more stuff to this one I opted to just give it a boost: Larger tires (but still just the one kind), AWD, and more power. Now it's the dedicated logger it was meant to be.

### Pacific P512

![Pacific P512](img/Pacific_P512.png)
...
![Ford CLT9000](img/Ford_CLT9000.png)
...
![International Transtar 4070A](img/International_Transtar_4070A.png)
...
![International Paystar 5070](img/International_Paystar_5070.png)
...
![International Paystar 5600TS](img/International_Paystar_5600TS.png)
...
But beyond that, this is one of my favorite trucks so I gave it one size larger tires and the ability to fit a high saddle because why not? More recently I added the articulated towing platform because I like it and wish it were an option on more trucks. It already had the ramped platform so again, why not?

### International Fleetstar F2070A

![International Fleetstar 4070A](img/International_Fleetstar_4070A.png)
...
![Chevy Kodiak C70](img/Chevy_Kodiak_C70.png)
...
![TUZ 16 Actaeon](img/TUZ_16_Actaeon.png)
...
![Kolob 74760](img/Kolob_74760.png)
...
![Khan 317 Sentinel](img/Khan_317_Sentinel.png)
...
![Freightliner 114SD](img/Freightliner_114SD.png)
...
![Step 33-64 "Crocodile"](img/Step_33-64_Crocodile.png)
...
![Tatra T813](img/Tatra_T813.png)

- Can fit 55" tires
- Can fit a Low Saddle
- Gets Active Suspension option
- Can fit a 1-slot flatbed
- Can fit a minicrane or a bandit crane

The T813 is already a great truck, but suffers a bit from low clearance and lack of crane attachment. It can fit the larger 55" tires under the stock suspension so I opted for an Active suspension so you can toggle it when needed. The mini cranes are useful when pulling a trailer, and there was room left for a 1-slot flatbed so I figured "why not?" You'll probably want to run the crane with a saddle, however.

### Tatra FORCE T815-7

![Tatra FORCE T815-7](img/Tatra_FORCE_T815-7.png)

- Can fit 54" and 57" tires
- Can fit a Low Saddle
- Gets an Active Suspension option

The Tatra FORCE is honestly such a good truck, it's another one that got some preferential treatment because I like it a lot. The larger tires and active suspension really allow it to go just about anywhere, and the Low Saddle lets it pull more kinds of trailers.

### Tatra PHOENIX

![Tatra PHOENIX](img/Tatra_PHOENIX.png)
...
It also gets some larger wheels and active suspension, allowing this truck to go just about anywhere as well.

### GMC Brigadier 8000

![GMC Brigadier 8000](img/GMC_Brigadier_8000.png)
...
![White Western Star 4964](img/White_Western_Star_4964.png)
...
![Azov 42-20 Antarctic](img/Azov_42-20_Antarctic.png)
...
![Western Star 6900 TwinSteer](img/Western_Star_6900_TwinSteer.png)
...
![Rezvani Hercules 6x6](img/Rezvani_Hercules_6x6.png)
...
![Land Rover Defender 90](img/Land_Rover_Defender_90.png)
...
![Land Rover Defender 110](img/Land_Rover_Defender_110.png)
...
![Western Star 57X](img/Western_Star_57X.png)
...
![Western Star 47X NF1424](img/Western_Star_47X_NF1424.png)
...
![Western Star 47X NF1430](img/Western_Star_47X_NF1430.png)
...
![Kirovets K-700](img/Kirovets_K-700.png)
...
I vastly prefer the manual diff lock to the always-on because always-on behaves like a Limited Slip Diff, where manual is an actual locker. For AWD, being able to shut it off can save you fuel. Mostly just personal preference.

Anyway, both tractors also suffered from a turning radius of "eventually" and a very slow turning rate, making them a pain to drive around a field. I boosted the steering speed and angle so they turn sharper and do it faster.

### Kirovets K-7M

![Kirovets K-7M](img/Kirovets_K-7M.png)
...
Exactly the same treatment as the K700, for the same reasons.

### Kenworth W990

![Kenworth W990](img/Kenworth_W990.png)
...
![Kenworth 963](img/Kenworth_963.png)
...
![Navistar 5000-MV](img/Navistar_5000-MV.png)
...
![Ank Mk38 Civilian](img/Ank_Mk38_Civilian.png)
...
![KRS 58 Bandit](img/KRS_58_Bandit.png)
...
You might say "The FEMM 37-AT is the best truck in the game, why are you modifying it???" and that would be a very valid question. Let's just say... you get the idea. I really like this truck and I needed to modify it anyway to convert the steering so I spent some time adding all the frame addons that would fit because this truck is *long*.

### Mack Defense M917

![Mack Defense M917](img/Mack_Defense_M917.png)
